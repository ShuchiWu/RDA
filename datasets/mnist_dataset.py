...
def get_downstream_mnist(args):
    ...
    downstream_training_data = TESTDATA(numpy_file=args.data_dir+training_file_name, class_type=mnist_classes, transform=test_transform)
    testing_data = TESTDATA(numpy_file=args.data_dir+testing_file_name, class_type=mnist_classes, transform=test_transform)
